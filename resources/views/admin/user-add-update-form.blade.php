    ...
    <!-- DataTables user listing -->
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                @if(isset($user))
                    {{ Form::model($user, ['route' => ['updateUserRouteAdmin', $user->id], 'method' => 'patch']) }}
                @else
                    {{ Form::open(['route' => 'addUserRouteAdmin']) }}
                @endif
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        {{ Form::select('role', ['worker' => 'Worker', 'client' => 'Client'], Request::old('role'), ['class' => 'form-control']) }}
                    </div>
                </div>
