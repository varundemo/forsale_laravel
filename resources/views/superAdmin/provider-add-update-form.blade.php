    ...
    <!-- DataTables user listing -->
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                @if(isset($provider))
                    {{ Form::model($provider, ['route' => ['updateTrustedServiceProviderRouteSuperAdmin', $provider->id], 'method' => 'patch']) }}
                @else
                    {{ Form::open(['route' => 'addTrustedServiceProviderRouteSuperAdmin']) }}
                @endif
