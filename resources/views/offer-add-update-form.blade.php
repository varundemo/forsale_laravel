...
@section('page_content')
    ...
    <!-- DataTables user listing -->
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                @if(isset($offer))
                    {{ Form::model($offer, ['route' => ['updateOfferRoute', $offer->id], 'method' => 'patch']) }}
                @else
                    {{ Form::open(['route' => 'addOfferRoute']) }}
                @endif
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        ...
                        <small>
                               <a href="{{ URL::to('/add-listing') }}">Add Listing</a> | <a href="{{ URL::to('/') }}" target="_blank">Search Properties</a>
                            <!-- | <a href="#" onclick="viewRecentOffers()">View Recent Offers</a> -->
                            | <a href="{{ URL::to('/view-recent-offers/{listing_no}') }}" onclick="viewRecentOffers()">View Recent Offers</a>
                        </small>
                    </div>
                    <div class="col-md-4">
                ...
                <!-- Changes start -->
                  <div class="form-group row">
                    <div class="col-md-12">
                        <label>
                            {{ Form::checkbox('acceptoff', 'yes') }}
                            Click want to be notified of all offers received
                        </label>
                    </div>
                </div>
                <!-- Changes End -->
    ...
    <script>
        ...
        function viewRecentOffers() {
            listing_no = $('select[name="listing_no"] option:selected').val();
            window.location = "/view-recent-offers/" + listing_no;
        }
    </script>
@endsection
